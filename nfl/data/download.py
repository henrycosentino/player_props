...
# ── NBA schedule ─────────────────────────────────────────────────────────
nfl_schedule_path_str = DATA_DIR + "/nfl_start_times.parquet"
nfl_schedule_path = Path(nfl_schedule_path_str)

if not nfl_schedule_path.is_file():
    seasons = [2025]
    schedule = nfl.load_schedules(seasons)

    schedule.write_parquet(nfl_schedule_path_str, )
