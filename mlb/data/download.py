...
SERIES_TICKERS = {
    "homeruns"         : "KXMLBHR",    # MLB: 'Rafael Devers records n+ home runs in a game'
    "strikeouts"       : "KXMLBKS",    # MLB: 'Logan Webb records n+ strikeouts in a game'
    "hits"             : "KXMLBHIT",   # MLB: 'Luis Arráez records n+ hits in a game'
    "hits_runs_rbi"    : "KXMLBHRR",   # MLB: 'Matt Chapman records n+ combined hits, runs, or RBIs in a game'
    "total_bases"      : "KXMLBTB",    # MLB: 'Willy Adames records n+ total bases in a game'
    "outs"             : "KXMLBOUTS",  # MLB: 'Logan Webb records n+ total outs in a game'
    "rbi"              : "KXMLBRBI",   # MLB: 'Heliot Ramos records n+ total RBIs in a game'
    "stolen_bases"     : "KXMLBSB",    # MLB: 'Jung Hoo Lee records n+ stolen bases in a game'
}
...
if not rt_path.is_file() and not recent_markets_df.empty:
    ...
    print('Skipping recent trades, data already downloaded or no recent markets in range.')
...
if not ht_path.is_file() and not historical_markets_df.empty:
    ...
    print('Skipping historical trades, data already downloaded or no historical markets available.')